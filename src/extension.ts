...
export function activate(context: vscode.ExtensionContext) {
    let generateDisposable = vscode.commands.registerCommand('swift-injection.generate', () => {
    ...
    let removeDisposable = vscode.commands.registerCommand('swift-injection.remove', () => {
        const editor = vscode.window.activeTextEditor;
        if (!editor) return;
...
function insertImportInject(text: string): string {
...
function insertObserveInjection(text: string): string {
...
function insertEnableInjection(text: string): string {
...
function removeImportInject(text: string): string {
    const lines = text.split(/\r?\n/);
...
function removeObserveInjection(text: string): string {
    const lines = text.split(/\r?\n/);
...
function removeEnableInjection(text: string): string {
    const lines = text.split(/\r?\n/);
